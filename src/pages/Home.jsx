    ...
    <div className=" overflow-auto scroll-smooth scrollbar-hide">
      ...
      <div className="py-20 overflow-auto scrollbar-hide">
        ...
        <Row
          ...
          type="Show"
          fetchURL={
            "https://api.themoviedb.org/3/tv/popular?api_key=2974558603f942cd73ecb0ba9db30e40&language=en-US&page=1"
          }
        />
        <Row
          rowID="9"
          ...
          type="Show"
          fetchURL={
            "https://api.themoviedb.org/3/tv/top_rated?api_key=2974558603f942cd73ecb0ba9db30e40&language=en-US&page=1"
          }
        />
